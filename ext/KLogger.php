...
/**
 * Added Log Environment to create log level checking
 */
...
class KLogger
{
     ...
     * @return KLogger
     */
    public static function instance($logDirectory = false, $severity = false, $logEnv = "PRO")
    {
        if ($severity === false) {
        ...
        self::$instances[$logDirectory] = new self($logDirectory, $severity, $logEnv);
     ...
     * @return void
     */
    public function __construct($logDirectory, $severity, $logEnv = "PRO")
    {
        $this->_logEnv = $logEnv;
